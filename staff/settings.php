  ...
  <body>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Settings & Configurations <small>Maymay Tailoring Centre</small></h1>
          </div>
          <!-- <div class="col-md-2">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h3 class="panel-title">Other Configurational Settings</h3>
                </div>
                <div class="panel-body">
