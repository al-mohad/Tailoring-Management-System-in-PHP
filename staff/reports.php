  ...
  <body>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-stats" aria-hidden="true"></span> Records & Reports <small>Maymay Tailoring Centre</small></h1>
          </div>
          <!-- <div class="col-md-2">
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              <div class="panel-heading" style="background-color: crimson;border-color: purple;color: white;">
                <h3 class="panel-title">Reports Overview</h3>
              </div>
