  ...
  <body>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-inbox" aria-hidden="true"></span> Messages & Notifications <small>Maymay Tailoring Centre</small></h1>
          </div>
          <!-- <div class="col-md-2">
          ...
          <div class="col-md-3">
            ...
            <div class="progress">
                <div class="progress-bar" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%;">
                    40%<output type="Date" name="phone" class="form-control" value=""></output>
            </div>
          </div>
            </div>-->
          </div>
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              <div class="panel-heading" style="background-color: crimson;border-color: purple;color: white;">
                <h3 class="panel-title" style="text-align: center;">Messages <span class="glyphicon glyphicon-inbox"></span> & Notifications <span class="glyphicon glyphicon-envelope"></span></h3>
              </div>
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h3 class="panel-title">Send Message(s)</h3>
                </div>
                <div class="panel-body">
                  <div class="row">
        <div class="col-sm-3">
