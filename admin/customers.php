          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              <div class="panel-heading" style="background-color: crimson;border-color: purple;color: white;">
                <h3 class="panel-title"><span class="glyphicon glyphicon-user"></span> Customers Overview</h3>
              </div>
              <div class="panel-body">
                              ...
                              <a href="print_customers.php" class="btn btn-success pull-right"><span class="glyphicon glyphicon-print"></span> PDF</a>
                              <p />
             ...
             // $sqli = "SELECT * FROM measurement";
              ...
              while($row = $query->fetch_assoc()){
                ...
                "<tr>
                  ...
                  <td>".$row['address']."</td>
                  <td>
                  <a href='#view_".$row['id']."' class='btn btn-success btn-sm' data-toggle='modal'> <span class='glyphicon glyphicon-eye-open'></span></a>
                  </td>
                  <td>
                    <a href='#edit_".$row['id']."' class='btn btn-success btn-sm' data-toggle='modal'> <span class='glyphicon glyphicon-edit'></span></a>
                    <a href='#delete_".$row['id']."' class='btn btn-danger btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-trash'></span></a>
