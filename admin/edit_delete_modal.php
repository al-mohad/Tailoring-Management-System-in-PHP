...
<div class="modal fade" id="view_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <center><h4 class="modal-title" id="myModalLabel">Customer Information</h4></center>
            </div>
            <div class="modal-body">
			<div class="container-fluid">
			<form method="POST" action="edit.php" style="font-weight: bolder;">
				...
				<div class="row form-group">
					<div class="col-md-6">
						<label class="control-label modal-label">Customer's Name:</label>
					</div>
					<div class="col-md-6">
				...
				<div class="row form-group">
					<div class="col-md-6">
						<label class="control-label modal-label">Shoulder Size:</label>
					</div>
					<div class="col-md-6">
				...
				<div class="row form-group">
					<div class="col-md-6">
						<label class="control-label modal-label">Half Cut Length:</label>
					</div>
					<div class="col-md-6">
						<?php echo $row['hcl']; ?>
					</div>
				...
				<div class="row form-group">
					<div class="col-md-6">
						<label class="control-label modal-label">Bust Size:</label>
					</div>
					<div class="col-md-6">
						<?php echo $row['bust']; ?>
					</div>
				...
				<div class="row form-group">
					<div class="col-md-6">
						<label class="control-label modal-label">Blouse Length:</label>
					</div>
					<div class="col-md-6">
						<?php echo $row['blouselength']; ?>
					</div>
				</div>
				<hr>
				<div class="row form-group">
					<div class="col-md-6">
						<label class="control-label modal-label">Blouse Waist:</label>
					</div>
					<div class="col-md-6">
						<?php echo $row['blousewaist']; ?>
					</div>
				</div>
				<hr>
				<div class="row form-group">
					<div class="col-md-6">
						<label class="control-label modal-label">Skirt Length:</label>
					</div>
					<div class="col-md-6">
						<?php echo $row['skirtlength']; ?>
					</div>
				</div>
				<hr>
				<div class="row form-group">
					<div class="col-md-6">
						<label class="control-label modal-label">Skirt Waist:</label>
					</div>
					<div class="col-md-6">
						<?php echo $row['skirtwaist']; ?>
					</div>
				</div>
				<hr>
				<div class="row form-group">
					<div class="col-md-6">
						<label class="control-label modal-label">Hips Size:</label>
					</div>
					<div class="col-md-6">
						<?php echo $row['hips']; ?>
					</div>
				...
				<div class="row form-group">
					<div class="col-md-6">
						<label class="control-label modal-label">Slip Length:</label>
					</div>
					<div class="col-md-6">
						<?php echo $row['sliplength']; ?>
					</div>
				</div>
				<hr>
				<div class="row form-group">
					<div class="col-md-6">
						<label class="control-label modal-label">Slip Round:</label>
					</div>
					<div class="col-md-6">
						<?php echo $row['slipround']; ?>
					</div>
				</div>
				<hr>
				<div class="row form-group">
