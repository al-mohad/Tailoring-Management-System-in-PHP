...
<html lang="en">
  <head>
    ...
    <title> MAYMAY | REGISTRATION </title>
      ...
      <nav class="navbar navbar-default">
        ...
        <!-- BODY CONTENTS -->
         <div class="container" style="color: purple;">
          <h1 align="center">NEW CUSTOMER REGISTRATION <br/><small>Please provide valid information so as to avoid inconvieniences</small></h1>
        </div>
        <div>
          <form method="POST" action="add.php" style="color: purple;">
        <div class="row form-group">
          <div class="col-sm-2">
            <label class="control-label modal-label">Fulname:</label>
          </div>
          <div class="col-sm-10">
